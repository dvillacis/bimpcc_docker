...
def interpolate(u, zx, zy, alpha, r, delta, theta, sizeout): 
    ...
    g1 = RegularGridInterpolator((yzx, xzx), matriz_zx, bounds_error=False, fill_value=None)
    ...
    g2 = RegularGridInterpolator((yzx, xzx), matriz_zy, bounds_error=False, fill_value=None)
    ...
    g3 = RegularGridInterpolator((yzx, xzx), matriz_r, bounds_error=False, fill_value=None)
    ...
    g4 = RegularGridInterpolator((yzx, xzx), matriz_d, bounds_error=False, fill_value=None)
    ...
    g5 = RegularGridInterpolator((yzx, xzx), matriz_t, bounds_error=False, fill_value=None)
